...
exports.config = {
  dsClientId:
    process.env.DS_CLIENT_ID || "2c38a412-74b6-47f0-8e76-6cd510138676", // The app's DocuSign integration key
  dsClientSecret:
    process.env.DS_CLIENT_SECRET || "98219462-d79c-40e9-b7bb-0c0d3d866193", // The app's DocuSign integration key's secret
  signerEmail: process.env.DS_SIGNER_EMAIL || "timg51237@gmail.com",
  signerName: process.env.DS_SIGNER_NAME || "Timothy Guoo",
  ...
  gatewayAccountId:
    process.env.DS_PAYMENT_GATEWAY_ID || "{DS_PAYMENT_GATEWAY_ID}",
  gatewayName: "stripe",
  gatewayDisplayName: "Stripe",
  githubExampleUrl:
    "https://github.com/docusign/eg-03-node-auth-code-grant/tree/master/lib/examples/",
  documentation: null,
  ...
  docOptions: [
    {
      ...
      name: "C#",
      githubExampleUrl:
        "https://github.com/docusign/eg-03-csharp-auth-code-grant-core/tree/master/eg-03-csharp-auth-code-grant-core/Controllers/",
      owner: "docusign",
    ...
    },
    {
      ...
      name: "PHP",
      githubExampleUrl:
        "https://github.com/docusign/eg-03-php-auth-code-grant/blob/master/src/",
      owner: "docusign",
    ...
    },
    {
      ...
      name: "Java",
      githubExampleUrl:
        "https://github.com/docusign/eg-03-java-auth-code-grant/tree/master/src/main/java/com/docusign/controller/examples/",
      owner: "docusign",
    ...
    },
    {
      ...
      name: "API / curl",
      githubExampleUrl:
        "https://github.com/docusign/eg-03-curl/tree/master/examples/",
      owner: "docusign",
      repo: "eg-03-curl",
      pathPrefix: "examples/"
    },
    {
      ...
      name: "Python",
      githubExampleUrl:
        "https://github.com/docusign/eg-03-python-auth-code-grant/tree/master/app/",
      owner: "docusign",
